...
export function parseIsoDate(dateStr) {
	...
	const parsed = new Date(Date.UTC(year, month - 1, day, RELEASE_HOUR_UTC, 0, 0));
...
export function randomArchiveDate(minIsoDate = "2025-12-01") {
	...
	const endDate = new Date(
		Date.UTC(today.getFullYear(), today.getMonth(), today.getDate(), RELEASE_HOUR_UTC, 0, 0)
	);
